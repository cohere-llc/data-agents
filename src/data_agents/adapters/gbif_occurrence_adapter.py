...
class GBIFOccurrenceAdapter(Adapter):
    ...
    def discover(self) -> dict[str, Any]:
        ...
        parameters = {
            ...
            "scientificName": {
                "type": "array",
                "description": (
                    "A scientific name from the GBIF backbone. All included and "
            ...
            "taxonKey": {
                "type": "array",
                "description": (
                    "A taxon key from the GBIF backbone. All included (child) and "
                    "synonym taxa are included in the search."
                ),
                "example": 2476674,
            },
            ...
            "country": {
                "type": "array",
                "description": (
                    "The 2-letter country code (as per ISO-3166-1) of the country in "
                    "which the occurrence was recorded."
                ),
                "example": "US",
            },
            "continent": {
            ...
            "geometry": {
                "type": "array",
                "description": (
                    "Searches for occurrences inside a polygon described in Well Known "
                    "Text (WKT) format."
                ),
            ...
            "geoDistance": {
                "type": "string",
                "description": (
                    "Filters to match occurrence records within a specified distance "
                    "of a coordinate."
                ),
                "example": "90,100,5km",
            },
            "hasCoordinate": {
                "type": "boolean",
                "description": (
                    "Limits searches to occurrence records which contain coordinate "
                    "values."
                ),
                "example": True,
            },
            ...
            "publishingCountry": {
                "type": "array",
                "description": (
                    "The 2-letter country code of the owning organization's country."
                ),
                "example": "US",
            },
            "institutionCode": {
                "type": "array",
                "description": (
                    "An identifier of any form assigned by the source to identify "
                    "the institution."
                ),
                "example": "GBIF",
            },
            ...
            "basisOfRecord": {
                "type": "array",
                "description": (
                    "Basis of record, as defined in GBIF BasisOfRecord vocabulary."
                ),
            ...
            "issue": {
                "type": "array",
                "description": (
                    "A specific interpretation issue as defined in GBIF "
            ...
            "limit": {
                "type": "integer",
                "description": (
                    "Controls the number of results in the page. Maximum is 300."
                ),
                "example": 20,
            },
            "offset": {
                "type": "integer",
                "description": (
                    "Determines the offset for the search results. Maximum offset "
                    "is 100,000."
                ),
                "example": 0,
            },
            ...
            "facet": {
                "type": "string",
                "description": (
                    "A facet name used to retrieve the most frequent values for "
                    "a field."
                ),
            ...
            "facetMincount": {
                "type": "integer",
                "description": (
                    "Used with facet parameter to exclude facets with a count less "
                    "than specified."
                ),
                "example": 1,
            },
            "facetMultiselect": {
                "type": "boolean",
                "description": (
                    "Used with facet parameter to return counts for values not "
                    "currently filtered."
                ),
                "example": True,
            },
            "facetLimit": {
                "type": "integer",
                "description": (
                    "Facet parameters allow paging requests using facetOffset and "
                    "facetLimit."
                ),
                "example": 10,
            },
        ...
        return {
            ...
            "description": (
                "GBIF Occurrence Search API - Search for biodiversity occurrence "
                "records"
            ),
    ...
    def count(self, **kwargs: Any) -> int:
        ...
        if hasattr(result_df, "attrs") and "gbif_metadata" in result_df.attrs:
            return int(result_df.attrs["gbif_metadata"]["count"])
        return 0

    def search_by_scientific_name(
        self, scientific_name: str, **kwargs: Any
    ) -> pd.DataFrame:
        """
    ...
    def search_by_year_range(
        self, start_year: int, end_year: int, **kwargs: Any
    ) -> pd.DataFrame:
        """
