...
Usage:
    python fetch_parameters.py [--output OUTPUT_FILE] [--community COMMUNITY] [--temporal TEMPORAL]
...
Examples:
    ...
    python fetch_parameters.py --community AG --temporal daily --output ag_daily_params.json
...
class NASAPowerParameterFetcher:
    ...
    def fetch_parameters(self, community: str, temporal: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def fetch_all_parameters(self, 
                           ...
                           temporal_frequencies: Optional[List[str]] = None) -> Dict[str, Any]:
        """
    ...
    def generate_summary(self, all_parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        summary['unique_parameters'] = sorted(list(summary['unique_parameters']))
...
def main():
    ...
    output_data: Dict[str, Any] = {
        'metadata': {
            ...
            'fetched_temporal_frequencies': temporal_frequencies or fetcher.TEMPORAL_FREQUENCIES
        },
