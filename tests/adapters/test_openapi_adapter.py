...
def test_openapi_adapter_initialization():
    ...
    adapter = OpenAPIAdapter(
        openapi_spec=sample_spec, config={"base_url": "https://api.example.com"}
    )
...
def test_openapi_adapter_from_nasa_power_file():
    ...
    adapter = OpenAPIAdapter(
        openapi_spec=spec_from_file, config={"base_url": "https://power.larc.nasa.gov"}
    )
    ...
    response_result = adapter.openapi_spec.unmarshal_response(
